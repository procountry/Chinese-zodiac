...
elements = ["Water", "Wood", "Fire", "Earth", "Metal"]  # Correct 60-year cycle
yin_yang = ["Yang", "Yin"]
...
for year in range(start_year, 2100):
    ...
    element = elements[((year - start_year) % 10) // 2]  # Every 2 years is the same element
